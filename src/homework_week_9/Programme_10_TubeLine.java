...
public class Programme_10_TubeLine {
    public static void main(String[] args) {
        ...
        String[] tubeStationZone1 = new String[]{"Aldgate", "Aldgate East", "Angel", "Baker Street", "Bank", "Barbican", "bayswater", "Blackfriars", "Bond Steet", "Borough", "Cannon Street", "Chancery Lane", "Charing Cross", "Covent Garden", "Earl's court", "Edgware Road", "Elephant & Castle", "Embankment", "Euston", "Euston Square", "Farringdon", "Gloucester Road", "Goodge Street", "Great Portland Street", "Green Park", "High Street Kensington", "Holborn", "Hyde Park Corner", "King's Cross", "Knightsbridge", "Lambeth North", "Lancaster Gate", "Leicester Square", "Liverpool Street", "London Bridge", "Mansion Houde", "Marblr Arc", "Marylebone", "Monument", "Moorgate", "Notting Hill Gate", "Old Street", "Oxford Circus", "Paddington", "Piccadilly Circus", "Pimlico", "Queensway", "Regents Park", "Russell Square", "Sloane Square", "South Kensington", "St Pancras", "Temple", "Tottenham Court Road", "Tower Gateway", "Tower Hill", "Vauxhall", "Victoria", "Warren Street", "Waterloo East", "Waterloo", "Westminster"};

       // System.out.println(tubeStationZone1.length);
        //for debug purpose
        ...
        londonUGLines[0][4] = "Elephant and castle";
        ...
        londonUGLines[8][3] = "Leiscester square";
